...
#define GIMBAL_ESTIMATE_TASK_PRIO 19            //任务优先级
#define GIMBAL_ESTIMATE_STK_SIZE 128             //任务堆栈


#define CONTROL_TASK_PRIO 22            //任务优先级
#define CONTROL_STK_SIZE 64             //任务堆栈

#define SD_TASK_PRIO 2            //任务优先级
#define SD_STK_SIZE 128             //任务堆栈
...
void start_task(void *pvParameters)
{
  ...
  //             (TaskHandle_t *)&User_Tasks[GIMBAL_TASK]); //任务句柄
    ...
    //               (TaskHandle_t *)&User_Tasks[SHOOT_TASK]); //任务句柄
  ...
  //             (TaskHandle_t *)&User_Tasks[MODECHOOSE_TASK]); //任务句柄
  ...
  //             (TaskHandle_t *)&User_Tasks[TX2_TASK]); //任务句柄
...
//              (TaskHandle_t *)&User_Tasks[PC_TASK]); //任务句柄
...
//                  (TaskHandle_t *)&User_Tasks[CPU_TASK]); //任务句柄
    ...
    //           (TaskHandle_t *)&User_Tasks[SD_TASK]);        //任务句柄
