...
//	VOFA_justfloat[7]=(float)(powerlimit.k_c);
//	
    //动态K采样
...
//	VOFA_justfloat[2]=(float)(powerlimit.actual_ina260_power);
	...
	VOFA_justfloat[9]=(float)(chassis.ChassisMotorCanReceive[1].Current);
...
//	VOFA_justfloat[0]=(float)(Robot_Disconnect.motor_rec_timer[0]);
//	VOFA_justfloat[1]=(float)(Robot_Disconnect.motor_rec_timer[1]);
//	VOFA_justfloat[2]=(float)(Robot_Disconnect.motor_rec_timer[2]);
//	VOFA_justfloat[3]=(float)(Robot_Disconnect.motor_rec_timer[3]);
