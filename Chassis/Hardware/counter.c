...
void COUNTER_Configuration(void)
{
    ...
    /*  1us */
    TIM_TimeBaseInitStructure.TIM_Period = UINT_MAX;
...
//{
//    TickType_t cnt_now = xTaskGetTickCount();
//    float dt = ((double)(xTaskGetTickCount()-*cnt_last))/1000;;
//    *cnt_last = cnt_now;
//	
//    return dt;
//}
...
{
    volatile uint16_t cnt_now = COUNTER_TIMx->CNT;
    float dt = ((uint16_t)(cnt_now - *cnt_last)) / ((float)(COUNTER_SAMPLING));
